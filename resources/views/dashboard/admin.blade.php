                ...
                <section id="services">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        ...
                        <a href="{{ route('events.index') }}"
                            ...
                            <img src="{{ asset('assets/images/calendar.png') }}" alt="Citas" class="w-full md:w-32 h-auto object-contain md:mr-6 mb-4 md:mb-0">
                        ...
                        <a href="{{ route('treatments.index') }}"
                            class="flex flex-col md:flex-row items-center p-6 bg-gray-100 rounded-2xl shadow-md hover:shadow-xl transition transform hover:scale-105 duration-300">
                            <img src="{{ asset('assets/images/budget.png') }}" alt="Presupuestos" class="w-full md:w-32 h-auto object-contain md:mr-6 mb-4 md:mb-0">
                            <div class="text-center md:text-left">
                        ...
                        <a href="{{ route('patient.index') }}"
                            class="flex flex-col md:flex-row items-center p-6 bg-gray-100 rounded-2xl shadow-md hover:shadow-xl transition transform hover:scale-105 duration-300">
                            <img src="{{ asset('assets/images/patient.png') }}" alt="Pacientes" class="w-full md:w-32 h-auto object-contain md:mr-6 mb-4 md:mb-0">
                            <div class="text-center md:text-left">
                        ...
                        <a href="{{ route('multimedia.index') }}"
                            class="flex flex-col md:flex-row items-center p-6 bg-gray-100 rounded-2xl shadow-md hover:shadow-xl transition transform hover:scale-105 duration-300">
                            <img src="{{ asset('assets/images/file.png') }}" alt="Archivos" class="w-full md:w-32 h-auto object-contain md:mr-6 mb-4 md:mb-0">
                            <div class="text-center md:text-left">
                        ...
                        <a href="{{ route('budgets.index') }}"
                            class="flex flex-col md:flex-row items-center p-6 bg-gray-100 rounded-2xl shadow-md hover:shadow-xl transition transform hover:scale-105 duration-300">
                            <img src="{{ asset('assets/images/report.png') }}" alt="Tratamientos" class="w-full md:w-32 h-auto object-contain md:mr-6 mb-4 md:mb-0">
                            <div class="text-center md:text-left">
                        ...
                        <a href="{{ route('payments.index') }}"
                            class="flex flex-col md:flex-row items-center p-6 bg-gray-100 rounded-2xl shadow-md hover:shadow-xl transition transform hover:scale-105 duration-300">
                            <img src="{{ asset('assets/images/finance.png') }}" alt="Pagos" class="w-full md:w-32 h-auto object-contain md:mr-6 mb-4 md:mb-0">
                            <div class="text-center md:text-left">
