...
<div class="max-w-5xl mx-auto bg-white rounded-xl p-6 text-gray-900">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('payments.show', $treatment->id) }}" class="botton2">{{ __('Volver a Pagos') }}</a>
    </div>
    ...
    @if($plan->installmentsCollection->isEmpty())
    ...
    @else
        ...
        @foreach($plan->installmentsCollection as $index => $installment)
